...
public class WlanMeasurementsDBCreation extends SQLiteOpenHelper {
    private static final String TAG = "WlanMeasurementsDBCreation";
    //  Database name
...
// DB version
    ...
    public WlanMeasurementsDBCreation(Context context) {
    ...
    public void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {
        Log.w(WlanMeasurementsDBCreation.class.getName(),
