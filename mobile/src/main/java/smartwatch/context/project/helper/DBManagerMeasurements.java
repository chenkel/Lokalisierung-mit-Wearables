package smartwatch.context.project.helper;
...
import smartwatch.context.common.db.WlanMeasurementsDBCreation;

public class DBManagerMeasurements extends Activity implements OnItemClickListener {
    ...
    private WlanMeasurementsDBCreation dbm;
...
// all global variables
    ...
    // --Commented out by Inspection (04.04.16, 15:27):indexInfo info = new indexInfo();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //in the below line Change the text 'yourCustomSqlHelper' with your DataHelper sqlitehelper class name
        dbm = new WlanMeasurementsDBCreation(DBManagerMeasurements.this);

        ScrollView mainscrollview = new ScrollView(DBManagerMeasurements.this);
        ...
        LinearLayout mainLayout = new LinearLayout(DBManagerMeasurements.this);
        ...
        TextView secondrowtext = new TextView(DBManagerMeasurements.this);
        secondrowtext.setText("No. Of Records : ");
        secondrowtext.setTextSize(20);
        secondrowtext.setLayoutParams(secondrowlp);
        tv = new TextView(DBManagerMeasurements.this);
        tv.setTextSize(20);
        ...
        final Button submitQuery = new Button(DBManagerMeasurements.this);
        ...
        final TextView help = new TextView(DBManagerMeasurements.this);
        ...
        final Spinner spinnertable = new Spinner(DBManagerMeasurements.this);
        ...
        final LinearLayout thirdrow = new LinearLayout(DBManagerMeasurements.this);
        previous = new Button(DBManagerMeasurements.this);
        previous.setText("Previous");

        previous.setBackgroundColor(Color.parseColor("#BAE7F6"));
        previous.setLayoutParams(secondrowlp);
        next = new Button(DBManagerMeasurements.this);
        next.setText("Next");
        ...
        tvmessage = new TextView(DBManagerMeasurements.this);
        ...
        final Button customQuery = new Button(DBManagerMeasurements.this);
        ...
        customQuery.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                //set drop down to DataHelper Query
        ...
        //when user enter a DataHelper query in text view and clicks on submit query button
        ...
        ArrayAdapter<String> tablenamesadapter = new ArrayAdapter<String>(DBManagerMeasurements.this,
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if (pos != 0) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(DBManagerMeasurements.this,
                    ...
                    if (c2 != null) {
                        ...
                        spinnertable.setOnItemSelectedListener((new OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            if (!isFinishing()) {
                                                ...
                                                new AlertDialog.Builder(DBManagerMeasurements.this)
                                ...
                                if (spinnertable.getSelectedItem().toString().equals("Add row to this table")) {
                                    ...
                                    final ScrollView addrowsv = new ScrollView(DBManagerMeasurements.this);
                                    ...
                                    final RelativeLayout addnewlayout = new RelativeLayout(DBManagerMeasurements.this);
                                    ...
                                    for (int i = 0; i < addnewrownames.size(); i++) {
                                        ...
                                        et.setId(k);
                                        final LinearLayout ll = new LinearLayout(DBManagerMeasurements.this);
                        ...
                        for (int k = 0; k < c2.getColumnCount(); k++) {
                            LinearLayout cell = new LinearLayout(DBManagerMeasurements.this);
    ...
    private void updateDeletePopup() {
        ...
        final RelativeLayout lp = new RelativeLayout(DBManagerMeasurements.this);
        lp.setBackgroundColor(Color.WHITE);
        RelativeLayout.LayoutParams lay = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        lay.addRule(RelativeLayout.ALIGN_PARENT_TOP);

        final ScrollView updaterowsv = new ScrollView(DBManagerMeasurements.this);
        LinearLayout lcrud = new LinearLayout(DBManagerMeasurements.this);
        ...
        ArrayAdapter<String> crudadapter = new ArrayAdapter<String>(DBManagerMeasurements.this,
    ...
    static class indexInfo {
        ...
        // --Commented out by Inspection (04.04.16, 15:27):public static Cursor maincursor;
        public static int cursorpostion = 0;
        public static ArrayList<String> value_string;
        // --Commented out by Inspection (04.04.16, 15:27):public static ArrayList<String> tableheadernames;
